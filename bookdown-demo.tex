...
\hypersetup{
  ...
  pdfauthor={Instructor: Po-Ju Ke \textasciitilde\textasciitilde\textasciitilde\textasciitilde\textasciitilde{} Teaching Assistant: Jia-Zhen Liu},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Introduction to Theoretical Ecology}
\author{Instructor: Po-Ju Ke \(~~~~~\) Teaching Assistant: Jia-Zhen Liu}
\date{2026 Fall at National Taiwan Univeristy \pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/bifurcation.gif}}}
...
\textbf{Teaching assistant}: Jia-Zhen Liu
...
\item
  Office: Life Science Building R635
\item
  Email: \href{mailto:r14b44011@ntu.edu.tw}{\nolinkurl{r14b44011@ntu.edu.tw}}
\item
  Office hours: by appointment
\end{itemize}
...
\begin{tabularx}{\linewidth}{>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\raggedright\arraybackslash}X}
\hline
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/bookdown-demo_files/figure-latex/unnamed-chunk-7-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/bookdown-demo_files/figure-latex/unnamed-chunk-10-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/bookdown-demo_files/figure-latex/unnamed-chunk-12-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/bookdown-demo_files/figure-latex/unnamed-chunk-12-2.pdf}}
