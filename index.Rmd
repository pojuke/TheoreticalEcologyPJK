...
syllabus <- tibble(
  ...
  `Lecture topic` = c("Introduction: what is theoretical ecology?",
                      ...
                      "9Midterm exam",
                      "10Lotka-Volterra model of competition: invasion analysis and linear stability analysis",
  ...
  Readings = c("Grainger et al. (2021) An empiricist's guide to using ecological theroy. The ",
               " \\- ",
               " \\- ",
               " \\- ",
               " \\- ",
