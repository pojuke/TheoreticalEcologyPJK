...
equation with different initial, which we will see that the number and stability of equilibrium changes when initial changes.
...
separate components of $dN/dt$, which the blue line is 
\[
\dfrac{HN}{A^2 + N^2}
\]
with different $H$ initials, the red line is, 
\[
r(1 - \dfrac{N}{K})
\]
...
## Calculate number of roots and stability across range or H
for(H in H.vec){
