...
**Part 2 - Comparing different ode solvers and iteration time**
<br>
...
# Compare different iteration time
par(mfrow = c(1,3))
plot(N ~ time, data = pop_size_1, main = "Iteration time = 11")
curve(state[1]*exp(parms[1]*x), col = "red", add = T) # correct curve
plot(N ~ time, data = pop_size_2, main = "Iteration time = 101")
curve(state[1]*exp(parms[1]*x), col = "red", add = T) # correct curve
plot(N ~ time, data = pop_size_3, main = "Iteration time = 1001")
curve(state[1]*exp(parms[1]*x), col = "red", add = T) # correct curve
```
