...
### (2) Set up different discrete model function with outside parameters
...
#### Ricker function with outside parameters
Ricker <- function(N, parms){
  with(as.list(parms), {
...
#### Beverton-Holt function with outside parameters
Beverton <- function(N, parms){
  with(as.list(parms), {
    return(lambda * N / (1 + alpha * N))
  })
}
Parms <- c(lambda = 1.2, alpha = 0.2)
